...
class H3DNet_v7(BaseModel):
    def __init__(self):
        super(H3DNet_v7, self).__init__()
        use_leaky_relu = True
        rgb_c = [64, 64, 128, 128]
        self.layer_rgb_conv = nn.Sequential(
        ...
        self.fuse_conv = nn.Sequential(
            nn.Conv2d(rgb_c[3] + pcd_c[3], fuse_c, kernel_size=3, stride=1, padding=1),
        ...
        # descriptor
        self.desc_header = nn.Sequential(
