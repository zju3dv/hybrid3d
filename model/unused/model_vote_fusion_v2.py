...
class PointConvModule(torch.nn.Module):
    def __init__(self, input_feature_dim=0):
        ...
        self.fp4 = PointnetFPModule(mlp=[256,256,128])
...
class VoteFusionModuleV2(torch.nn.Module):
    def __init__(self, in_dim=None, out_dim=128, config=None):
        ...
        self.fuse_fp1 = PointnetFPModule(mlp=[256+256,256,256])
    ...
    def forward(self, input):
        ...
        pcd_seed_features = torch.cat([pcd_seed_features, torch.zeros_like(pcd_seed_features)], dim=1) # [B, 128, Npcd]->[B, 256, Npcd]
...
if __name__=='__main__':
    backbone_net = VoteFusionModuleV2(out_dim=128).cuda()
    # print(backbone_net)
    backbone_net.eval()
    out = backbone_net({
